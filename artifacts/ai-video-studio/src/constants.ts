...
export const FIXED_CHARACTERS: Character[] = [
  {
    ...
    nameAr: "الشيخ الحكيم",
    role: "حكيم / مستشار",
    description: "رجل مسن ذو لحية بيضاء وملابس تقليدية رصينة. يتحدث بحكمة عميقة وصوت هادئ وموزون.",
    avatar: "https://images.unsplash.com/photo-1542103749-8ef59b94f4b3?auto=format&fit=crop&q=80&w=300&h=300",
    style: "realistic",
    preferredVoice: "sheikh",
    preferredDialect: "modern_standard",  // الفصحى المعاصرة
  },
  {
    id: "bedouin-warrior",
    ...
    style: "realistic",
    preferredVoice: "bedouin",
    preferredDialect: "bedouin",          // اللهجة البدوية / الخليجية
  },
  {
    id: "nabati-poetess",
    name: "Nabati Poetess",
    ...
    preferredDialect: "bedouin",          // اللهجة الخليجية النسائية
  },
  {
    id: "middle-eastern-man",
    name: "Modern Arab Man",
    nameAr: "شاب مصري عصري",
    role: "مهني محترف",
    description: "شاب مصري بمظهر مهني عصري، ملامح واضحة ونظرة واثقة. صوت مصقول ولبق.",
    ...
    preferredDialect: "egyptian",         // اللهجة المصرية
  },
  {
    ...
    nameAr: "فتاة سورية",
    role: "رائدة شبابية",
    description: "فتاة سورية جميلة ذات عيون معبرة وصوت ودود وناعم.",
    ...
    preferredDialect: "syrian",           // اللهجة الشامية
  },
  {
    id: "realistic-girl",
    name: "Arabic Girl",
    nameAr: "بنت عربية",
    role: "شخصية رئيسية",
    description: "فتاة عربية بملامح بريئة وعيون واسعة. تعبر عن الفرح والفضول.",
    avatar: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&q=80&w=300&h=300",
    style: "realistic",
    preferredVoice: "female",
    preferredDialect: "modern_standard",  // عربية فصحى نسائية
  },
  {
    ...
    nameAr: "شاب شامي",
    role: "بطل القصة",
    description: "شاب سوري في العشرينات بملامح حادة ومظهر عصري وأنيق. يمتلك نظرة واثقة وصوت قوي.",
  ...
  },
  {
    ...
    nameAr: "طفل عربي",
    role: "شخصية مساعدة",
    description: "طفل صغير مرح ذو شعر مبعثر وابتسامة دافئة. يمثل البراءة والمغامرة.",
    avatar: "https://images.unsplash.com/photo-1519238263530-99bdd1102f00?auto=format&fit=crop&q=80&w=300&h=300",
    style: "realistic",
    preferredVoice: "child",
    preferredDialect: "modern_standard",  // لغة طفل (فصحى مبسطة)
  },
  {
    ...
    style: "realistic",
    preferredVoice: "old-man",
    preferredDialect: "modern_standard",  // فصحى موقّرة
  },
  {
    id: "cartoon-boy",
    name: "Cartoon Boy",
    nameAr: "نصور (كرتون)",
    role: "بطل القصة",
    description: "ولد كرتوني لطيف بعيون واسعة ومعبرة وملابس مستقبلية زاهية. لمسة ديزني عربية.",
    avatar: "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fit=crop&q=80&w=200&h=200",
    style: "cartoon",
    preferredVoice: "child",
    preferredDialect: "egyptian",         // عامية مصرية مرحة
  },
  {
    id: "cartoon-girl",
    name: "Cartoon Girl",
    ...
    style: "cartoon",
    preferredVoice: "girl",
    preferredDialect: "egyptian",         // عامية مصرية أنثوية
  },
  {
    id: "cartoon-old-man",
    ...
    style: "cartoon",
    preferredVoice: "old-man",
    preferredDialect: "egyptian",         // عامية مصرية كوميدية
  },
];
