        ...
        {!isMobile ? (
          <div className="flex items-center space-x-6">
            <button
              ...
              className="flex items-center gap-2 bg-zinc-900 hover:bg-zinc-800 rounded-full px-4 py-1.5 border border-zinc-800 hover:border-blue-500/40 transition-colors group"
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={() => setShowSecrets(true)}
              className="w-8 h-8 rounded-full border border-zinc-800 flex items-center justify-center bg-zinc-900/50 hover:bg-zinc-800 active:scale-95 transition-all"
